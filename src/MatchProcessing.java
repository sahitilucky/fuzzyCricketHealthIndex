...
//	 System.out.println(Team1Battingscores);
	 ...
	 while(line!=null){
		 ...
		 if(Overs!=1){
			 double  Deltarr=presentrunrate-Prevrunrate;
			 double DeltaHI;
			 
			 if(wickets!=0){
			//	 PlayersGoneTeam1=new ArrayList<String>();
				 DeltaHI=GetHealthIndex(Team1,Team2,Team1Battingscores,Team2Bowlingscores,Overs,new ArrayList<String>(),Runrate,Deltarr);
				 HealthIndex += DeltaHI;
				 wickets=0;
				 System.out.println(" Deltarr:"+Deltarr+" DeltaHI:"+DeltaHI+" wickets:"+wickets+" Overs:"+Overs);
				 System.out.println("Health Index: "+HealthIndex);
				 filewriter.write(Integer.toString(Overs)+" "+Double.toString(HealthIndex)+"\n");
			 }
			 
			 DeltaHI=GetHealthIndex(Team1,Team2,Team1Battingscores,Team2Bowlingscores,Overs,PlayersGoneTeam1,Runrate,Deltarr);
			 HealthIndex += DeltaHI;
			 System.out.println("Health Index: "+HealthIndex);
			 System.out.println("Presentrunrate: "+Runrate+" Deltarr:"+Deltarr+" DeltaHI:"+DeltaHI+" wickets:"+wickets+" Overs:"+Overs);
			 filewriter.write(Integer.toString(Overs)+" "+Double.toString(HealthIndex)+"\n");
	...
	while(line!=null  ){
		 ...
		 double diffrr=Runrate-RequiredRunrate;
		 
		 HealthIndex=GetHealthIndex2(Team2,Team1,Team2Battingscores,Team1Bowlingscores,Overs,PlayersGoneTeam2,Runrate,diffrr);
...
private double GetHealthIndex2(ArrayList<String> team2,
			ArrayList<String> team1, ArrayList<Integer> team2Battingscores,
			ArrayList<Integer> team1Bowlingscores, int overs,
			ArrayList<String> playersGoneTeam2, double runrate, double diffrr) {
				
		// TODO Auto-generated method stub
/*
	double[] deltarrfuzzified=dr.fuzzify(deltarr);
	...
	System.out.println(Arrays.toString(deltarrfuzzified));
	//May be Present Runrate should also be involved in prediction
	f2.Applyrules(overfuzzified,WSfuzzified,deltarrfuzzified);
...
private double GetHealthIndex(ArrayList<String> Batting, ArrayList<String> Bowling,
		ArrayList<Integer> Battingscores, ArrayList<Integer> Bowlingscores,
		int overs, ArrayList<String> Batsmangone, double runrate, double deltarr) {
	// TODO Auto-generated method stub
	int rts=0;		//RTS
	int bts=0;		//BTS
...
//	System.out.println("RTS: "+rts+" BTS:"+bts);
	...
	System.out.println(Arrays.toString(deltarrfuzzified));
	//May be Present Runrate should also be involved in prediction
	f.Applyrules(overfuzzified,WSfuzzified,deltarrfuzzified);
	double deltaHI=f.Averagedefuzzification();
	return deltaHI;
}
	...
	private void Getallplayers(String matchname,ArrayList<String> team1, ArrayList<String> team2, ArrayList<Integer> team1Battingscores,
		...
		FileReader file2=new FileReader("/home/sahiti/MBR/Project/t20s/Preprocess/CountryShortNames");
		...
		file=new FileReader("/home/sahiti/MBR/Project/t20s/Preprocess/"+monthname+"_"+year+"_Batting_Preprocess");
	...
	//			System.out.println(line);
		...
		file=new FileReader("/home/sahiti/MBR/Project/t20s/Preprocess/"+monthname+"_"+year+"_Bowling_Preprocess");
		filereader=new BufferedReader(file);
		line=filereader.readLine();
		while(line!=null){
			items=line.split(",");
	...
	private double GetScalingFactor(String venue) throws IOException {
		// TODO Auto-generated method stub
		FileReader file=new FileReader("/home/sahiti/MBR/Project/t20s/Preprocess/Pitchaveragescores");
		BufferedReader filereader=new BufferedReader(file);
...
*/
	...
	public static void main(String[] args) throws IOException{
		MatchProcessing match=new MatchProcessing();
		/*
...
//		match.ProcessMatch("nwc/567367.txt");
//		match.ProcessMatch("nwc/636537.txt");
		match.ProcessMatch("nwc/685727.txt");
		match.runFsg("python plot.py","dump.txt");
	}
